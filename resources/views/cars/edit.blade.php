                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <!-- MAKE -->
                            <div class="form-row form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="inputMake" name="make" class="form-control"
                                           placeholder="Make" value="{{ old('make') != "" ? old('make') : $car->make }}"
                            ...
                            <div class="form-row form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="inputCategory" name="category" class="form-control"
                                           ...
                                           value="{{ old('category') != "" ? old('category') : $car->category }}"
                                           data-toggle="dropdown" aria-haspopup="true"
                                           aria-expanded="false">
                            ...
                            <div class="form-row form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="number" id="inputSpeed" name="speed" class="form-control" step="0.1"
                                           placeholder="Speed"
                                           value="{{ old('speed') != "" ? old('speed') : $car->speed }}">
                                </div>
                            </div>
                            ...
                            <div class="form-row form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="number" id="inputAcceleration" name="acceleration" class="form-control"
                                           ...
                                           value="{{ old('acceleration') != "" ? old('acceleration') : $car->acceleration }}">
                                </div>
                            </div>
                            ...
                            <div class="form-row form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="number" id="inputBraking" name="braking" class="form-control"
                                           ...
                                           value="{{ old('braking') != "" ? old('braking') : $car->braking }}">
                                </div>
                            </div>
                            ...
                            <div class="form-row form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="number" id="inputCornering" name="cornering" class="form-control"
                                           ...
                                           value="{{ old('cornering') != "" ? old('cornering') : $car->cornering }}">
                                </div>
                            </div>
                            ...
                            <div class="form-row form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="number" id="inputStability" name="stability" class="form-control"
                                           ...
                                           value="{{ old('stability') != "" ? old('stability') : $car->stability }}">
                                </div>
                            </div>
                            ...
                            <div class="form-row form-group">
                                ...
                                <div class="col-md-9 input-group">
                                    <input type="number" id="inputPower" name="power" class="form-control"
                                           placeholder="Power"
                                           value="{{ old('power') != "" ? old('power') : $car->power }}">
                            ...
                            <div class="form-row form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="inputDrive" name="drive" class="form-control"
                                           placeholder="Drive"
                                           value="{{ old('drive') != "" ? old('drive') : $car->drive }}"
                                           data-toggle="dropdown" aria-haspopup="true"
                                           aria-expanded="false">
                            ...
                            <!-- PRICE -->
                            <div class="form-row form-group">
                                <label for="inputCount" class="col-md-3 col-form-label">Count</label>
                                <div class="col-md-9 input-group">
                                    <input type="number" id="inputCount" name="count" class="form-control"
                                           placeholder="Count"
                                           value="{{ old('count') != "" ? old('count') : $car->count }}">
                                </div>
                            </div>
                            ...
                            <div class="form-row form-group">
                                ...
                                <div class="col-md-4 offset-md-1">
                                    <a href="{{ route('cars.view', ['id' => $car->id]) }}"
